...
DECLARE_CLASS_WITHOUT_TRAMPOLINE(R3AgentSample03,SingleAssetAgent)
	...
	*/
    ...
    public:
    R3AgentSample03(const nl::json& modelConfig_,const nl::json& instanceConfig_);
    virtual ~R3AgentSample03();
