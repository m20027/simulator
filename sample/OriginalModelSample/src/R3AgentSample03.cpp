...
R3AgentSample03::R3AgentSample03(const nl::json& modelConfig_,const nl::json& instanceConfig_)
...
R3AgentSample03::~R3AgentSample03(){}

void R3AgentSample03::validate(){
    ...
    if(parent->isinstance<CoordinatedFighter>()){
        ...
        throw std::runtime_error("R3AgentSample03 accepts only MassPointFighrer or CoordinatedFighter.");
    }
...
py::object R3AgentSample03::observation_space(){
...
py::object R3AgentSample03::makeObs(){
    ...
    if(count==0){
        ...
        for(int t=0;t<maxT;++t){
            ...
            for(auto&& f:parent->observables.at("/shared/fighter"_json_pointer).items()){
                ...
                obs.block(ofs+1,0,3,1)=dr/R;
                obs(ofs+4)=V/fgtrVelNormalizer;
                obs.block(ofs+5,0,3,1)=dv/V;
...
Eigen::VectorXf R3AgentSample03::makeSingleObs(){
    Eigen::VectorXd obs=Eigen::VectorXd::Zero(singleDim);
...
py::object R3AgentSample03::action_space(){
...
void R3AgentSample03::deploy(py::object action_){
...
py::object R3AgentSample03::convertActionFromAnother(const nl::json& decision,const nl::json& command){
...
void exportR3AgentSample03(py::module &m)
{
    using namespace pybind11::literals;
    EXPOSE_LOCAL_CLASS(R3AgentSample03)
    DEF_FUNC(R3AgentSample03,validate)
    DEF_FUNC(R3AgentSample03,observation_space)
    DEF_FUNC(R3AgentSample03,makeObs)
    DEF_FUNC(R3AgentSample03,action_space)
    DEF_FUNC(R3AgentSample03,deploy)
    DEF_FUNC(R3AgentSample03,control)
    DEF_FUNC(R3AgentSample03,convertActionFromAnother)
    .def("convertActionFromAnother",[](R3AgentSample03& v,const py::object& decision,const py::object& command){
